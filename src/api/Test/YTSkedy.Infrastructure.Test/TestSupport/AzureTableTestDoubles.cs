    ...
    : InMemoryTableClient<PlatformPublicationEntity>
{
    ...
    protected override PlatformPublicationEntity Clone(PlatformPublicationEntity entity) =>
        new()
        {
            ...
            FailureProviderStatus = entity.FailureProviderStatus,
            FailureProviderErrorCode = entity.FailureProviderErrorCode,
            FailureRetryAfterUtc = entity.FailureRetryAfterUtc,
            FailedUtc = entity.FailedUtc,
            FailureAttemptId = entity.FailureAttemptId,
            FailureVerificationRequired = entity.FailureVerificationRequired,
            PublishSettingsJson = entity.PublishSettingsJson,
