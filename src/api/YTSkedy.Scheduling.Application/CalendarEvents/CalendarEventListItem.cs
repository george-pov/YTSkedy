...
/// <summary>
/// Calendar event read model behind the list and detail HTTP responses. Carries
/// the stored YouTube broadcast id (null until published) and exposes the action
/// eligibility the UI consumes. The flags delegate to
